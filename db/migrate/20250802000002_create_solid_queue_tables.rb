class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    create_table :solid_queue_jobs do |t|
      ...
      t.index [:queue_name, :finished_at], name: "index_solid_queue_jobs_for_polling"
      t.index [:active_job_id], unique: true
      t.index [:class_name]
      t.index [:scheduled_at]
      t.index [:priority, :created_at]
      t.index [:concurrency_key, :priority, :created_at], name: "index_solid_queue_jobs_for_concurrency_key"
    end
    ...
    create_table :solid_queue_ready_executions do |t|
      ...
      t.index [:queue_name, :priority, :job_id], name: "index_solid_queue_ready_executions_for_polling"
    end
    ...
    create_table :solid_queue_blocked_executions do |t|
      ...
      t.index [:expires_at, :concurrency_key], name: "index_solid_queue_blocked_executions_for_expiry"
      t.index [:concurrency_key, :priority, :job_id], name: "index_solid_queue_blocked_executions_for_polling"
    end
